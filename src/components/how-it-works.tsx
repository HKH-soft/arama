...
const steps = [
  {
    ...
    num: "۰۱",
    title: "گفتگو می‌کنی",
    text: "از هر چیزی که در ذهنت هست بگو.",
  ...
  },
  {
    ...
    text: "آراما به تو کمک می‌کند احساساتت را بهتر بشناسی.",
  ...
  },
  {
    ...
    num: "۰۳",
    title: "تمرین می‌کنی",
    text: "تمرین مناسب همان لحظه را پیشنهاد می‌دهد.",
    tint: "bg-tint-strong text-brand-ink",
  },
  {
    icon: BookHeart,
    ...
    text: "پیشرفتت را هفته‌به‌هفته دنبال کن.",
    tint: "bg-sand-soft text-clay",
  },
];
