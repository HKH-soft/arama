...
export default function ProfilePageClient({
  ...
  // Re-fetch profile data on mount to stay current
  useEffect(() => {
        ...
        <TabsContent value="security" className="space-y-6 mt-6">
          <Card dir="rtl">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <h3 className="font-medium mb-2">حذف حساب کاربری</h3>
                ...
                {showDeleteDialog && (
                  <div className="mt-4 p-4 border border-destructive rounded-lg space-y-4">
                    <p className="text-sm text-destructive font-medium">
                      برای تأیید حذف، رمز عبور خود را وارد کنید:
                    </p>
                    <div className="flex gap-2">
                      <Input
                        type="password"
