...
export default function AnalyticsPage() {
  return (
    <>
      <div className="bg-gradient-to-b from-indigo-900/40 via-[#1a1a2e] to-[#121212] px-6 pt-6 pb-4">
        <h1 className="text-2xl font-bold text-white">تحلیل احساسات</h1>
      ...
      <div className="px-6 pb-6 space-y-6">
            ...
            {[
              ...
              <div key={i}>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-white/50">{e.pct}٪</span>
                </div>
        ...
        <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/10 rounded-lg p-6 border border-indigo-500/10">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            این هفته سطح آرامش شما ۱۵٪ بهتر از هفته گذشته بوده. تمرینات تنفسی
            که انجام دادید تأثیر مثبتی روی کاهش اضطراب داشته. ادامه بدید!
          </p>
        </div>
      </div>
    </>
