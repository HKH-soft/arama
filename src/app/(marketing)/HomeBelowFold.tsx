    ...
    <>
      ...
      <section id="pricing" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div
            className={`grid grid-cols-1 gap-8 ${plans.length === 1 ? "md:grid-cols-1 max-w-md mx-auto" : plans.length === 2 ? "md:grid-cols-2 max-w-2xl mx-auto" : plans.length === 3 ? "md:grid-cols-3" : "md:grid-cols-2 lg:grid-cols-4"}`}
          >
            {plans.length > 0 ? (
                ...
                >
                  ...
                  <div className="mb-8">
                    ...
                    <span className="text-muted-foreground mr-1">
                      {plan.price === 0
                        ? "تومان"
                        : `تومان / ${plan.durationDays === 30 ? "ماه" : plan.durationDays === 365 ? "سال" : ""}`}
                    </span>
                  </div>
