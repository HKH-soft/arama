  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2 text-sm">ایمیل خود را وارد کنید تا لینک بازنشانی برایتان ارسال شود.</p>
      </div>
      ...
      <div className="bg-card rounded-2xl border border-border shadow-sm p-8">
        {sent ? (
          <div className="text-center space-y-4">
            ...
            <p className="text-foreground">لینک بازنشانی رمز عبور به ایمیل شما ارسال شد.</p>
            <Link href="/login" className="text-primary hover:text-primary/80 text-sm inline-flex items-center gap-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="email" placeholder="example@domain.com" className="pr-10 bg-background text-left" dir="ltr" required value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
              </div>
