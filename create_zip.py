    ...
    with zipfile.ZipFile(output_filename, 'w', zipfile.ZIP_DEFLATED) as zipf:
        for root, dirs, files in os.walk(source_dir):
            ...
            for file in files:
                ...
                if file_path == os.path.join(source_dir, output_filename) or 'arama-' in file and file.endswith('.zip'):
                    continue
...
if __name__ == '__main__':
    ...
    output = r'c:\Users\erfanali\Desktop\arama-main\arama-project-final.zip'
